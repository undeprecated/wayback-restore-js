...
function Process( settings ) {
    ...
    this.settings.directory = path.normalize( this.settings.directory + '/' + this.settings.domain )
...
Process.prototype.saveResults = async function () {
    await this.saveToFile( this.settings.resultsFile, JSON.stringify( this.results ) );
};
...
Process.prototype.saveAsset = async function ( asset ) {
    ...
    await this.saveToFile( asset.filename, asset.content );
    return asset;
};
